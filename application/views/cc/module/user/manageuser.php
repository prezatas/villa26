...
<head>	
	...
	<title>Wedding Choice / Manage User</title>	
</head>
                        ...
                        <div class="col-md-12">
                        	<div class="card">
                                ...
                                <div class="card-header">
                                	<div class="row">
                                    	<div class="col-md-6">
                                    		<i class="fa fa-align-justify"></i> Manage User Table
                                        </div>
                                        <div class="col-md-6">
                                            <div class="main-search">
                                                <form action="<?php echo base_url('cc/user/manageuser')?>" method="post">
                                                    ...
                                                    <a  class="search-nav-button btn-refresh"  href="<?php if($search !=""){ echo base_url('cc/user/unsetsearch');}else{echo base_url('cc/user/manageuser');}?>"><span><i class="fa fa-refresh"></i></span></a>
                                                </form>
                                            </div>
                                         </div>
                            		</div>
                                ...
                                <ul class="ul-btn-lists  mB-20">
                                    ...
                                    <li>
                                        <form name="deletefiles" action="<?php echo base_url('cc/user/deleteuserselectprocess')?>" method="post">
                                	...
                                	<table class="table table-responsive-sm table-bordered table-striped table-sm">
                                                ...
                                                <tbody>
                                        			...
                                        			<tr>
                                                        ...
                                                        <td><?php echo $user->ur_title;?></td>
                                                        <td class="active-td">
                                                        	<?php if($user->user_status=="active"){?>
                                                            <a href="<?php echo base_url('cc/user/useractivation')?>?u_id=<?php echo $user->user_id;?>&action=deactive&pageno=<?php echo $pageno;?>" onClick="return getConfirm('Deactivate')">
                                                                <button type="button" class="btn-red btn-active">Deactivate</button></a>
                                                            <?php } else{?>
                                                            <a href="<?php echo base_url('cc/user/useractivation')?>?u_id=<?php echo $user->user_id; ?>&action=active&pageno=<?php echo $pageno;?>" onClick="return getConfirm('Activate')">
                                                                <button type="button" class="btn-green btn-active">Activate</button></a>
                                                        	<?php } ?>
                                                        </td>
                                                        <td>
                                                        <div class="action-buttons">
                                                            <a class="" href="<?php echo base_url('cc/user/viewuser')?>?u_id=<?php echo $user->user_id;?>">
                                                                <i class="ace-icon fa fa-search bigger-130"></i>
                                                            </a>

                                                            <a class="green" href="<?php echo base_url('cc/user/updateuser')?>?u_id=<?php echo $user->user_id;?>&pageno=<?php echo $pageno;?>">
                                                                <i class="ace-icon fa fa-pencil bigger-130"></i>
                                                            </a>

                                                            

                                                            <a class="red" onclick="return confirmDelete()" href="<?php echo base_url('cc/user/deleteuserprocess')?>?u_id=<?php echo $user->user_id;?>">
                                                                <i class="ace-icon fa fa-trash-o bigger-130"></i>
                                                            </a>
                                                        </div>
                                                    </td>
                                                        <td>
                                                        	<input type="checkbox" value="<?php echo $user->user_id;?>" name="checklist[]" id="check_box">
                                                        </td>
                                        			</tr>
                                                    <?php }?>
                                                </tbody>
