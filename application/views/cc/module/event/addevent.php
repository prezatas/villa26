...
<head>	
	...
	<title>Wedding Choice / Add Event</title>	
</head>
            ...
            <main class="main">
                ...
                <div class="container">
                	...
                	<div class="row">
                        ...
                        <div class="col-md-8">
                        	<div class="card">
                            	           <form id="form" name="form" method="post" enctype="multipart/form-data" onsubmit="return imageValidate()" action="<?php echo base_url('cc/event/addeventprocess')?>">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="form-group col-md-6">
                                        	<label for="rtitle">Event Title<span class="required">*</span></label>
                                            <input type="text"  maxlength="20" class="form-control" id="etitle" name="etitle" placeholder="Event Title" value="<?php echo set_value('rtitle'); ?>">
