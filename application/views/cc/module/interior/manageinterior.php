...
<head>	
	...
	<title>Wedding Choice / Manage Interior</title>	
</head>
                        ...
                        <div class="col-md-12">
                        	<div class="card">
                                ...
                                <div class="card-header">
                                	<div class="row">
                                    	<div class="col-md-6">
                                    		<i class="fa fa-align-justify"></i> Manage Interior Table
                                        </div>
                                        <div class="col-md-6">
                                            <div class="main-search">
                                                <form action="<?php echo base_url('cc/interior/manageinterior')?>" method="post">
                                                    ...
                                                    <a  class="search-nav-button btn-refresh"  href="<?php if($search !=""){ echo base_url('cc/interior/unsetsearch');}else{echo base_url('cc/interior/manageinterior');}?>"><span><i class="fa fa-refresh"></i></span></a>
                                                </form>
                                            </div>
                                         </div>
                            		</div>
                                ...
                                <ul class="ul-btn-lists  mB-20">
                                    ...
                                    <li>
                                        <form name="deletefiles" action="<?php echo base_url('cc/interior/deleteinteriorselectprocess')?>" method="post">
                                                ...
                                                <tbody>
                                        			...
                                        			<tr>
                                                        ...
                                                        <div class="action-buttons">
                                                            <a class="" href="<?php echo base_url('cc/interior/viewinterior')?>?i_id=<?php echo $gallery->g_id;?>">
                                                                <i class="ace-icon fa fa-search bigger-130"></i>
                                                            </a>

                                                            
                                                            <a class="red" onclick="return confirmDelete()" href="<?php echo base_url('cc/interior/deleteinteriorprocess')?>?i_id=<?php echo $gallery->g_id;?>">
