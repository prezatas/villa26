...
<head>	
	...
	<title>Wedding Choice / Add Fandb</title>	
</head>
            ...
            <main class="main">
                ...
                <div class="container">
                	...
                	<div class="row">
                        ...
                        <div class="col-md-8">
                        	<div class="card">
                            	<form name="form" method="post" name="form" enctype="multipart/form-data" action="<?php echo base_url('cc/fandb/addfandbprocess'); ?>" onsubmit="return addInterior()">
                                <div class="card-header">
                                    <strong>Add Fandb</strong>
                                    <small>Form</small>
                                </div><!--card header-->
                                	...
                                	<div class="form-row">
                                    	...
                                    	<div class="form-group col-md-12">
                                            ...
                                            <div class="file-loading">
                                                ...
                                                <input id="file-4" name="image[]" type="file" multiple accept="image/x-png, image/gif, image/jpeg">
